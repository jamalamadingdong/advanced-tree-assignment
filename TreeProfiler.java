...
public class TreeProfiler
{
    ...
    *           options to interact with the tree.        
    **************************************************************************/
    private static void mainMenuBT ()
    {
        DSAQueue load = null;
        DecimalFormat dp2 = new DecimalFormat("#0.00");
        BlockTree tree = null;
    ...
    *           options to interact with the tree.        
    **************************************************************************/
    private static void mainMenuTTFT ()
    {
        DSAQueue load = null;
        DecimalFormat dp2 = new DecimalFormat("#0.00");
    ...
    *           line argument.        
    **************************************************************************/
    private static void profiler (String type, int size, String filename)
    {
        DecimalFormat dp2 = new DecimalFormat("#0.00");
        if(type.equals("BST"))
        {
    ...
    **************************************************************************/
    private static String strInput (String prompt)
    {
        String str;
        Scanner sc = new Scanner (System.in);
